<%@ Page Title="" Language="C#" MasterPageFile="~/header.Master" AutoEventWireup="true" CodeBehind="monitoreos_lista_noaptos.aspx.cs" Inherits="medallia.monitoreos_lista_noaptos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            lista_pendiente_aptos(3,centro);
        });
    </script>
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">NO APTO</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">Bandeja de monitoreos No Apto</h3>
                            </div>
                            <!-- /.card-header -->
