<%@ Page Title="" Language="C#" MasterPageFile="~/header.Master" AutoEventWireup="true" CodeBehind="monitoreos_form.aspx.cs" Inherits="medallia.monitoreos_form" %>
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Formulario de carga</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <select id="drop_tecnico" class="form-control col-sm-8" onchange="cbio_cbo_tecnico();"></select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group row">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <input type="checkbox" class="form-control col-sm-1" id="chk_tecnico" onclick="chk_habilita(); ingresante_checado();" value="chk_tec" />&nbsp;|&nbsp;&nbsp;
                                        <input type="button" class="btn btn-primary" id="btn_historia_tec" value="Historial del T&eacute;cnico" />
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label for="chk_tecnico" class="col-sm-3 col-form-label">Empresa</label>
                                        <select class="form-control col-sm-6" id="cbo_empresa"></select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <center>
                                        ...
                                        <input class="btn btn-primary mr-2" type="button" id="btn_guardar" value="Guardar" onclick="guardar(1)" />
