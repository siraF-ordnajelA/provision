<%@ Page Title="" Language="C#" MasterPageFile="~/header.Master" AutoEventWireup="true" CodeBehind="monitoreos_lista_provisorios.aspx.cs" Inherits="medallia.monitoreos_lista_provisorios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            lista_pendiente_aptos(2, centro);
        });
    </script>
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">PROVISORIO</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Bandeja de monitoreos Provisorio</h3>
                            </div>
                            <!-- /.card-header -->
