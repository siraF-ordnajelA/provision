...
select LEFT ([Técnico], 100),
	...
	LEFT ([Desviado], 3),
	LEFT ([Ubicacion], 50),
	case when [Enrutado automático a fecha] = '' then null else CAST (replace ([Enrutado automático a fecha],'/','') as date) end,
	...
	case when [Fecha Ingreso TOA] = '' then null else [Fecha Ingreso TOA] end,
	'PROGRAMADO',
