alter procedure q4s_30d_B_actualiza_informados
@opc tinyint
/*
1 = MES COMPLETO
2 = MES ANTERIOR
...
create table #informes (id_tecnico smallint, Estado varchar (25), Cuenta smallint, cent_id smallint null, tecno varchar(20))


-- INSERTA INFORMADOS
insert into #informes (id_tecnico, Estado, Cuenta, cent_id, tecno)
