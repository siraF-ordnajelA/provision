alter procedure av_inserta_historico_7dias
as
...
set @fecha1 = cast (getdate() - 14 as date)
set @fecha2 = cast (getdate() - 7 as date)
set @fecha_averias_fin = dateadd (day, 8, @fecha2)
...
--ELIMINO AVERIAS DE MAS DE 7 DIAS
update #compa2
set Averia = 'INCORRECTO +7',
	Garantias = 0
where [Fecha avería] is not null and
		datediff (day, [Fecha instacion], [Fecha avería]) > 7
...
insert into av_historico_contrata_7_dias (Empresa, Instalaciones, fecha)
...
--GARANTIAS A 7 DIAS
merge into av_historico_contrata_7_dias as destino
...
--COLOCO A CERO
update av_historico_contrata_7_dias
set Garantias = 0
