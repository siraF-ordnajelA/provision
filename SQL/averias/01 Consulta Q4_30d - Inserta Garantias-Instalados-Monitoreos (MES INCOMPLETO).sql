...
--METRICA INCOMPLETA (Cualquier día del mes)
...
--OJO ELIMINA EL ULTIMO MES SI SE TRATA DEL DÍA 1
delete from Q4s_30d
where Fecha = @fecha1
...
insert into Q4s_30d (id_contrata, Tecnico, id_tecnico, Instalaciones, Garantias, Monitoreos, [Monitoreos Apto], tecnologia, Fecha)
