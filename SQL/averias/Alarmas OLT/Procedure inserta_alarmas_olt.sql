...
FROM T1000.GPON_EXPRESSE.dbo.REPORTE_ALARMA_IS_OOS as a
WHERE CAST(a.fecha_foto as DATE) = CAST(getdate() as DATE)
...
FROM T1000.GPON_EXPRESSE.dbo.A_ELIMINAR_REPORTE_ALARMA_IS_OOS as a left join [10.244.89.164].BOU.dbo.tecnicos as b  
