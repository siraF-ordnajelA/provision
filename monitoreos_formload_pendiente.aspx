<%@ Page Title="" Language="C#" MasterPageFile="~/header.Master" AutoEventWireup="true" CodeBehind="monitoreos_formload_pendiente.aspx.cs" Inherits="medallia.monitoreos_formload_pendiente" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <center>
                                        <input class="btn btn-primary mr-2" type="button" id="btn_guardar" value="Guardar" onclick="guardar(2)" />
